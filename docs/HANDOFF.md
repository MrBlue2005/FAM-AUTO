...
- Each property row has a direct Preview action with day-by-day Facebook-style post previews. It opens as a right-side panel with its own contained scroll, so copy and media can be checked without opening the editor or moving the list position.
