...
export const api = {
  ...
  isLiveExecutionEnabled: () => liveExecutionEnabled,
  ...
  updateManagedUserLiveExecutionPolicy: (userId, { enabled }) => request(`/admin/users/${encodeURIComponent(userId)}/live-execution-policy`, { method: 'PATCH', body: JSON.stringify({ enabled }) }),
  ...
  getManagedUserCampaignVisibility: (userId) => request(`/admin/users/${encodeURIComponent(userId)}/campaign-visibility`),
  createManagedUserCampaignVisibility: (userId, { campaignId }) => request(`/admin/users/${encodeURIComponent(userId)}/campaign-visibility`, { method: 'POST', body: JSON.stringify({ campaignId }) }),
  updateManagedUserCampaignVisibility: (userId, campaignId, { enabled }) => request(`/admin/users/${encodeURIComponent(userId)}/campaign-visibility/${encodeURIComponent(campaignId)}`, { method: 'PATCH', body: JSON.stringify({ enabled }) }),
  getManagedUserTargetVisibility: (userId) => request(`/admin/users/${encodeURIComponent(userId)}/target-visibility`),
  createManagedUserTargetVisibility: (userId, { targetId }) => request(`/admin/users/${encodeURIComponent(userId)}/target-visibility`, { method: 'POST', body: JSON.stringify({ targetId }) }),
  updateManagedUserTargetVisibility: (userId, targetId, { enabled }) => request(`/admin/users/${encodeURIComponent(userId)}/target-visibility/${encodeURIComponent(targetId)}`, { method: 'PATCH', body: JSON.stringify({ enabled }) }),
  ...
  issueLiveConfirmation: (intent) => request('/cloud-remote-tasks/live-confirmations', { method: 'POST', body: JSON.stringify(campaignPreflightRequestBody(intent)) }),
  createLiveCampaignExecutionTask: ({ confirmationToken, ...intent }) => request('/cloud-remote-tasks/live-campaign-execution', { method: 'POST', body: JSON.stringify({ ...campaignPreflightRequestBody(intent), ...(typeof confirmationToken === 'string' ? { confirmationToken } : {}) }) }),
