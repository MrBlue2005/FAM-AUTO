...
export const api = {
  ...
  createLiveCampaignExecutionTask: (intent) => request('/cloud-remote-tasks/live-campaign-execution', { method: 'POST', body: JSON.stringify(campaignPreflightRequestBody(intent)) }),
