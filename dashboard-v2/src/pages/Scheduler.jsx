          ...
          {schedules.map((schedule) => (
            <article className={`schedule-card ${schedule.enabled ? '' : 'disabled'}`} key={schedule.id}>
              <div className="schedule-card-main">
                ...
                <p>{schedule.campaignIds.length} campanii / Ziua {schedule.campaignDay} / {schedule.groupLimit === 'all' ? 'toate grupurile' : `${schedule.groupLimit} grupuri`} / {schedule.publishEnabled ? 'LIVE' : 'TEST'}</p>
