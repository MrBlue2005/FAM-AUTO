...
const USER_PERMISSIONS = new Set([PERMISSIONS.CAMPAIGNS_READ, PERMISSIONS.CAMPAIGNS_WRITE, PERMISSIONS.MEDIA_READ, PERMISSIONS.MEDIA_WRITE, PERMISSIONS.TARGETS_READ, PERMISSIONS.TARGETS_WRITE, PERMISSIONS.SCHEDULES_READ, PERMISSIONS.SCHEDULES_WRITE, PERMISSIONS.EXECUTION_PREFLIGHT]);
